...
async def cmd_prompt(event: types.Message | CallbackQuery):
    ...
    prompt_text = (
        ...
        "अगर आपके पास किसी <b>किताब की फोटो, PYQ, PDF या थ्योरी नोट्स</b> हैं, तो नीचे दिए गए बॉक्स पर क्लिक करके <b> Copy</b>  करें:\n\n"
        "<code>कृपया दिए गए Photo / PDF / थ्योरी नोट्स को ध्यान से पढ़ें और इनसे ऑब्जेक्टिव प्रश्न (MCQs) बनाकर मुझे बिल्कुल इसी फॉर्मेट में दें:\n\n"
        ...
        "4. उत्तर देने में कोई भी फालतू बात या परिचय न लिखें। सिर्फ और सिर्फ प्रश्नों की लिस्ट दें।</code>\n\n"
        "📌 <b>उपयोग करने की विधि:</b>\n"
        "1. ऊपर दिए गए कोड पर टैप करके <b>Copy</b>  करें।\n"
        "2. <b> Google Gemini App</b>  (या चैट) में जाएं।\n"
        "3. अपनी फोटो / PDF अटैच करें और यह Prompt पेस्ट करके भेजें।\n"
